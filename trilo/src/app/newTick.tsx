...
export default function NewTick(props: { checked?, addTick }) {
    ...
    return (
        <div className="flex flex-nowrap">
            <span className="text-nowrap font-bold text-lg text-red-700 mt-0.5 select-none">{checked ? "X " : "O "}</span><span className="mt-0.5 select-none">&nbsp;|</span>
            ...
            <button onClick={click} className="ml-3 rounded-full p-1 text-sm border-white border-2 border-solid select-none">Add</button>
        </div>
    )
}