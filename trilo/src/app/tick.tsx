...
export default function Tick(props:{text:String,idkey:string,identifier:string,checked?:Boolean,handleClick?:any,dragEnd?:any}){
    ...
    return(
        <div id={identifier} data-idkey={idkey} draggable={true} onDragStart={drag} onDragEnd={dragEnd} onClick={handleClick} className="mb-2 touch-manipulation min-w-full border-2 border-white " >
